...
1. Log in to `pelle.uppmax.uu.se` using a terminal app and `ssh`
2. Type `id` in the command line
3. Copy the output of the command and email back (to the course organisers at `edu.epigenomics@nbis.se`
